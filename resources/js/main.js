...
$(document).ready(function () {
    ...
    ********************************/
    $(".addToCartBtn").click(function (e) {
        ...
        // Using FormData for the form associated with the clicked button
        ...
        $.ajax({
            ...
            success: function (res) {
                if (res.is_in_cart) {
                    $('.addToCartBtn[data-product-id="' + productId + '"]').text('Added to Cart');
                    alert('The Item is in the cart Click again to add more.');

                } else {
                    // Handle if the product is not in the cart (optional)
    ...
    /*********************************
    // *Itratting over each button to check if the itwm alreay in the cart or not
    ********************************/
    ...
    ********************************/
    $('.remove-item-cart-btn').on('click', function (e) {
        ...
        var row = $('tr[data-product-row-id="' + productId + '"]');
        ...
        $.ajax({
            ...
            method: 'post',
            data: {
                product_id: productId, _token: csrfToken
            },
            success: function (response) {
    ...
    ********************************/
    ...
    $('.qtybtn').on('click', function () {
        ...
        var totalAmount = $('.order-total-amount');
        '';
    });
